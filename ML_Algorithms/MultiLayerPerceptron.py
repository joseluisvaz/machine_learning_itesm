...
def sigmoid_backward(dA, Z):
    dG = np.multiply(sigmoid(Z)[0],(1-sigmoid(Z)[0]))
...
def L_model_forward(X, parameters):
    ...
    # Implementation of [LINEAR -> RELU]*(L-1).
    for l in range(1, L):
        A_prev = A
...
def compute_cost(AL, Y):
    """
    Implementation the cost function defined by equation (7).
...
def linear_backward(dZ, cache):
    """
    Implementation the linear portion of backward propagation for a single layer (layer l)
